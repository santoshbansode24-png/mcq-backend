...
addIndex($pdo, 'teacher_classes', 'idx_tc_class_code', 'class_code');
addIndex($pdo, 'class_updates', 'idx_cu_teacher_id', 'teacher_id');
addIndex($pdo, 'videos', 'idx_videos_chapter_id', 'chapter_id');
addIndex($pdo, 'notes', 'idx_notes_chapter_id', 'chapter_id');
