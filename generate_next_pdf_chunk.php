...
try {
    ...
    2. STRICT NATIVE LANGUAGE MATCH: If the source text is written in Marathi, EVERY SINGLE output MUST be in Marathi. If Hindi, output MUST be Hindi. If English, output MUST be English.
    3. FORMAT: Return ONLY a valid JSON object. No markdown wrappers.
