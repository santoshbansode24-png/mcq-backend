...
try {
    // Rate Limiting: Max 5 failed attempts per IP or Identifier in the last hour
    ...
    // Auto-initialize PIN if user had no PIN configured previously
    ...
    // Update Password, Security PIN & Timestamps
